...
if __name__ == '__main__':
    ...
    sentiment_location = path.join(Constants.DATASETS_MARKET, 'technicalsentiment.results.csv')
    processing(price_source, item, sentiment_location, False, processing_type)
    sentiment_location = path.join(Constants.DATASETS_MARKET, 'twitter.results.csv')
    processing(price_source, item, sentiment_location, False, processing_type)
